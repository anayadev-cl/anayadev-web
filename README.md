...
- **Productos**: administrar la familia ZIA (nombre, eslogan, descripción,
  estado, características, imagen y enlace). El sufijo `-zia` se pinta
  automáticamente con el degradado de marca.
...
- **Ajustes**: correo de contacto, WhatsApp, redes y textos globales.
...
- CRUD bajo `/api/v1/admin/*` (secciones, productos, mensajes, ajustes, medios).
